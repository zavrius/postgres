...
REM Объявление заголовка пакета с 2 процедурами
...
REM Включение вывода в консоль
SET SERVEROUTPUT ON

REM Тестовый блок. Вызов созданных объектов через анонимный блок.
DECLARE
